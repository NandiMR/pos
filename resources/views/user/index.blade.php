				...
				<div class="card-body">
					<form action="#" enctype="multipart/form-data" id="form" class="form-horizontal">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="nama_user" id="nama_user" class="form-control" value="{{ $user->name }}">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="email_user" id="email_user" class="form-control" value="{{ $user->email }}">
								<span class="help-block"></span>
							</div>
						</div>
						<div class="form-group row">
