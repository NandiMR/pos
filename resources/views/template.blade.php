...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('template/dataTables/css/dataTables.bootstrap4.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed {{ request()->is('penjualan') ? 'sidebar-collapse' : '' }}">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="/home" class="brand-link">
        <img src="{{ asset('template/dist/img/12.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
        style="opacity: .8">
...
<script type="text/javascript" src="{{ asset('template/dataTables/js/dataTables.bootstrap4.min.js') }}"></script>
