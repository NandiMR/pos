                ...
                <div class="card-body login-card-body">
                    ...
                    <form action="#" id="form">
                        ...
                        <div class="input-group pb-3">
                            <input id="nama" type="text" class="form-control" name="nama" id="nama" value="<?php echo e(old('nama')); ?>" required autocomplete="nama" autofocus placeholder="Nama">
                        ...
                        <div class="input-group pb-3">
                            <input id="email" type="text" class="form-control" name="email" id="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus placeholder="Email">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-envelope"></span>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\Desktop\pos\resources\views/auth/register.blade.php ENDPATH**/ ?>