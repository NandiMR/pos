...
<script type="text/javascript">
	$(document).ready(function(){
		table = $('#table').DataTable({
			processing : true,
			serverside : true,
			ajax : "<?php echo e(route('pelanggan.index')); ?>",
			columns: [
	...
	function get(id){
		$.ajax({
			url : "<?php echo e(route('pelanggan.index')); ?>"+"/"+id+"/edit",
			type: "GET",
			dataType: "JSON",
			success: function(data){
				...
				$('[name="email"]').val(data.email_pelanggan);
				$('[name="telp"]').val(data.no_telp_pelanggan);
				$('[name="alamat"]').val(data.alamat_pelanggan);
				$('#modal-form').modal('show');
	...
	function simpan(){
		$.ajax({
			url: "<?php echo e(route('pelanggan.store')); ?>",
			data: $('#form').serialize(),
			type: "POST",
			dataType: 'json',
			success: function (data) {
...
<?php echo $__env->make('../template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\Desktop\pos\resources\views/pelanggan/index.blade.php ENDPATH**/ ?>