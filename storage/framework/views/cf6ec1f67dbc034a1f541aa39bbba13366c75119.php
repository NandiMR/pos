  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="/home" class="brand-link">
        <img src="<?php echo e(asset('template/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
        style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(url('peminjaman')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Penjualan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('pengembalian')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pembelian</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo e(url('profil')); ?>" class="nav-link">
              <i class="nav-icon fa fa-user-edit"></i>
              <p>Profil</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
            <a href="<?php echo e(url('password')); ?>" class="nav-link">
...
<?php /**PATH C:\Users\Hp\Desktop\pos\resources\views/template.blade.php ENDPATH**/ ?>