							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-lg-8">
											<input type="text" name="no_penjualan" value="<?php echo e($no_penjualan); ?>" id="no_penjualan" readonly class="form-control">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4">Tanggal</label>
										<div class="col-lg-8">
											<input type="text" name="tanggal" class="form-control" value="<?php echo e(date('d-m-Y')); ?>" readonly>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-4">Kasir</label>
										<div class="col-lg-8">
											<input type="text" name="kasir" class="form-control" value="<?php echo e(Auth::user()->username); ?>" readonly>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-8">
											<select class="form-control" name="pelanggan" id="pelanggan">
												...
												<option value="<?php echo e($p->nama_pelanggan); ?>"><?php echo e($p->nama_pelanggan); ?></option>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		table1 = $('#table-produk').DataTable({
			processing : true,
			serverside : true,
			ajax : "<?php echo e(url('penjualan/produk')); ?>",
			columns: [
		...
		$('#pelanggan').on('change', function(){
			...
			$.ajax({
				url: "<?php echo e(url('penjualan/get-pelanggan')); ?>",
				type: "GET",
				dataType: "JSON",
		...
		$('#detail').load("<?php echo e(url('penjualan/tampil-keranjang')); ?>", function(){
			hitung();
		});
	...
	function tambah(){
		...
		$.ajax({
			url: "<?php echo e(url('penjualan/keranjang')); ?>"+"/"+id,
			type: "POST",
			dataType: "JSON",
			data: {
				qty : qty
	...
	function get(id){
		$.ajax({
			url: "<?php echo e(url('penjualan/get-keranjang')); ?>"+"/"+id,
			type: "GET",
			dataType: "JSON",
			success: function(data){
	...
	function edit(){
		$.ajax({
			url: "<?php echo e(url('penjualan/edit-keranjang')); ?>",
			type: "POST",
			dataType: "JSON",
			data: $("#form").serialize(),
			success: function(data){
	...
	function del(id){
		$.ajax({
			url: "<?php echo e(url('penjualan/hapus')); ?>"+"/"+id,
			type: "DELETE",
			dataType: "JSON",
			success: function(data){
				if (data.status == true) {
	...
	function proses(){
		...
		if (total < 1) {
			...
			$.ajax({
				url: "<?php echo e(url('penjualan/proses')); ?>",
				type: "POST",
				dataType: "JSON",
				data: {
	...
	function batal(){
		$.ajax({
			url: "<?php echo e(url('penjualan/reset')); ?>",
			type: "POST",
			success: function(){
				location.reload();
			}
...
<?php echo $__env->make('../template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hp\Desktop\pos\resources\views/transaksi/penjualan/index.blade.php ENDPATH**/ ?>